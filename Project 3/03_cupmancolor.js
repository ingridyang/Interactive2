...
let body = document.querySelector('#body')
  body.addEventListener('click',function(e){
    ...
    body.style.backgroundImage = `url(photocolor/person_`+currentSwatch+`person.png)`
})

let back = document.querySelector('#back')
  back.addEventListener('click',function(e){
    console.log(`url(photocolor/heart_`+currentSwatch+`back.png)`)
    back.style.backgroundImage = `url(photocolor/person_`+currentSwatch+`back.png)`
})

let bot = document.querySelector('#bot')
  bot.addEventListener('click',function(e){
    console.log(`url(photocolor/heart_`+currentSwatch+`bot.png)`)
    bot.style.backgroundImage = `url(photocolor/person_`+currentSwatch+`bot.png)`
})
